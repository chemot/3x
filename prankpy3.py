...
botStart = time.time()
prank = LineClient(authToken='EvK8AotMGRDSuSURLEG7.rYQ2taYWmIaHwZoX6iKQ1W.4x3H2UyooRqw262T2LrtHVfLYExUAa/VCrLK0v57d/s=')
...
#======================
pb1 = LineClient(authToken='EvN6Gc7v7FTf2BEEfNK6.BaiKNxR2VN7zWCBrQS6P5G.caWZLpJZ2OQP17CbG1yLz/fzUQJvDpKjZoySCcTFkBI=')
pb1.log("Auth Token : " + str(pb1.authToken))
#======================
pb2 = LineClient(authToken='EvdEWSYoEXAWwGEdKhma.UHbbg4pHBjT5VwCYtXmXsG.ljMksZprMaQQKiw8fqUqIXklykIrHv87YYMvWf9xK9o=')
